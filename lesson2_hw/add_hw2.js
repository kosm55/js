...
if (friends.length >= 3)
    console.log('це великий масив, в якому  3 і більше елемент');
else
...
if ((a > b && b < c && a < c || a < b && b > c && a > c)) {
    console.log('a середнє')
} else if
((a < b && b < c && a < c) || (a > b && b > c && a > c)) {
    console.log('b середнє')
} else if
((a < b && b > c && a < c) || (a > b && b < c && a > c)) {
    console.log('c середнє')
} else
...
let s1=2;
s1= s1 > 0 ? 'позитивним' : s1===0 ? 'нулем' : 'негативним' ;
    console.log(s1)
...
let nameJS= ('Яка «офіційна» назва JavaScript?')
